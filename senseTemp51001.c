...
float senseTemperature(){
        ...
        if(fp = popen("cat /sys/devices/w1_bus_master1/28-00000521fa01/w1_slave","r")){
                if(fp == NULL){
                ...
                while (fgets(tempReading, sizeof(tempReading)-1, fp) != NULL) {
                        ...
                        char * myString= "$ cat /sys/devices/w1_bus_master1/28-00000521fa01/w1_slave\
